...
namespace Kartrider.API.Exceptions
{
    ...
    /// API 호출 예외 클래스
    /// </summary>
    public class KartAPIException : System.Exception
    {
        /// <summary>
        ...
        public KartAPIException(string message,string queryParameter, string apiKey,KartAPIStatusCode kartAPIStatusCode) : base(message)
        {
